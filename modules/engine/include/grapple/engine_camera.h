...
extern "C"
{
    ...
    typedef struct Grapple_Camera
    {
        ...
        /** @brief Accessibility multiplier synchronized by CameraInit/CameraUpdate. */
        float shake_scale;
     ...
     *  to nothing. CameraInit/CameraUpdate apply the engine screen-shake setting automatically. */
