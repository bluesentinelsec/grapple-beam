...
static void GenRead_Grapple_Camera(lua_State *L, int idx, Grapple_Camera *out)
{
    ...
    out->shake_scale = (float)GrappleGen_LuaFieldNum(L, idx, "shake_scale");
...
static void GenPush_Grapple_Camera(lua_State *L, const Grapple_Camera *in)
{
    ...
    lua_pushnumber(L, (lua_Number)in->shake_scale);
    lua_setfield(L, -2, "shake_scale");
...
static void GenPush_Grapple_ChipDiagnostic(lua_State *L, const Grapple_ChipDiagnostic *in)
{
    ...
    lua_pushinteger(L, (lua_Integer)in->part);
    lua_setfield(L, -2, "part");
    lua_pushinteger(L, (lua_Integer)in->measure);
...
static void GenRead_Grapple_ChipEffects(lua_State *L, int idx, Grapple_ChipEffects *out)
{
    memset(out, 0, sizeof(*out));
    if (!lua_istable(L, idx)) { return; }
    out->chorus = (float)GrappleGen_LuaFieldNum(L, idx, "chorus");
    out->delay = (float)GrappleGen_LuaFieldNum(L, idx, "delay");
    out->delay_beats = (float)GrappleGen_LuaFieldNum(L, idx, "delay_beats");
    out->delay_feedback = (float)GrappleGen_LuaFieldNum(L, idx, "delay_feedback");
    out->reverb = (float)GrappleGen_LuaFieldNum(L, idx, "reverb");
...
static void GenPush_Grapple_ChipEffects(lua_State *L, const Grapple_ChipEffects *in)
{
    ...
    lua_pushnumber(L, (lua_Number)in->delay_beats);
    lua_setfield(L, -2, "delay_beats");
    lua_pushnumber(L, (lua_Number)in->delay_feedback);
    lua_setfield(L, -2, "delay_feedback");
    lua_pushnumber(L, (lua_Number)in->reverb);
    lua_setfield(L, -2, "reverb");
    lua_pushnumber(L, (lua_Number)in->motion);
    lua_setfield(L, -2, "motion");
    lua_pushnumber(L, (lua_Number)in->pulse_beats);
...
static void GenRead_Grapple_ChipImportOptions(lua_State *L, int idx, Grapple_ChipImportOptions *out)
{
    ...
    out->fermata_factor = (double)GrappleGen_LuaFieldNum(L, idx, "fermata_factor");
    out->swing_ratio = (double)GrappleGen_LuaFieldNum(L, idx, "swing_ratio");
}
...
static void GenPush_Grapple_ChipImportOptions(lua_State *L, const Grapple_ChipImportOptions *in)
{
    ...
    lua_setfield(L, -2, "ornament_beats");
    lua_pushnumber(L, (lua_Number)in->arpeggio_beats);
    lua_setfield(L, -2, "arpeggio_beats");
    lua_pushnumber(L, (lua_Number)in->fermata_factor);
    lua_setfield(L, -2, "fermata_factor");
    lua_pushnumber(L, (lua_Number)in->swing_ratio);
    lua_setfield(L, -2, "swing_ratio");
}

static void GenPush_Grapple_ChipMapping(lua_State *L, const Grapple_ChipMapping *in)
{
    lua_createtable(L, 0, 4);
    lua_pushinteger(L, (lua_Integer)in->preset);
    lua_setfield(L, -2, "preset");
    lua_pushinteger(L, (lua_Integer)in->reason);
    lua_setfield(L, -2, "reason");
    lua_pushinteger(L, (lua_Integer)in->program);
    lua_setfield(L, -2, "program");
    lua_pushinteger(L, (lua_Integer)in->channel);
    lua_setfield(L, -2, "channel");
}

static void GenRead_Grapple_ChipNote(lua_State *L, int idx, Grapple_ChipNote *out)
{
    memset(out, 0, sizeof(*out));
    if (!lua_istable(L, idx)) { return; }
    out->track = (int)GrappleGen_LuaFieldInt(L, idx, "track");
    out->note = (int)GrappleGen_LuaFieldInt(L, idx, "note");
    out->velocity = (int)GrappleGen_LuaFieldInt(L, idx, "velocity");
    out->start_tick = (Uint64)GrappleGen_LuaFieldInt(L, idx, "start_tick");
    out->duration_ticks = (Uint64)GrappleGen_LuaFieldInt(L, idx, "duration_ticks");
}

static void GenPush_Grapple_ChipPosition(lua_State *L, const Grapple_ChipPosition *in)
{
    lua_createtable(L, 0, 7);
    lua_pushnumber(L, (lua_Number)in->seconds);
    lua_setfield(L, -2, "seconds");
    lua_pushnumber(L, (lua_Number)in->beat);
    lua_setfield(L, -2, "beat");
    lua_pushinteger(L, (lua_Integer)in->tick);
    lua_setfield(L, -2, "tick");
    lua_pushinteger(L, (lua_Integer)in->source_measure);
    lua_setfield(L, -2, "source_measure");
    lua_pushinteger(L, (lua_Integer)in->measure_visit);
    lua_setfield(L, -2, "measure_visit");
    lua_pushnumber(L, (lua_Number)in->measure_beat);
...
static void GenPush_Grapple_ChipSection(lua_State *L, const Grapple_ChipSection *in)
{
    ...
    lua_pushinteger(L, (lua_Integer)in->start_tick);
    lua_setfield(L, -2, "start_tick");
    lua_pushinteger(L, (lua_Integer)in->end_tick);
    lua_setfield(L, -2, "end_tick");
    lua_pushinteger(L, (lua_Integer)in->source_measure);
    lua_setfield(L, -2, "source_measure");
    lua_pushinteger(L, (lua_Integer)in->measure_visit);
    lua_setfield(L, -2, "measure_visit");
...
static void GenPush_Grapple_ChipSongInfo(lua_State *L, const Grapple_ChipSongInfo *in)
{
    lua_createtable(L, 0, 4);
    lua_pushinteger(L, (lua_Integer)in->track_count);
    lua_setfield(L, -2, "track_count");
    lua_pushinteger(L, (lua_Integer)in->ticks_per_quarter);
    lua_setfield(L, -2, "ticks_per_quarter");
    lua_pushinteger(L, (lua_Integer)in->duration_ticks);
    lua_setfield(L, -2, "duration_ticks");
    lua_pushnumber(L, (lua_Number)in->duration_seconds);
...
static void GenRead_Grapple_ChipTrackMix(lua_State *L, int idx, Grapple_ChipTrackMix *out)
{
    memset(out, 0, sizeof(*out));
    if (!lua_istable(L, idx)) { return; }
    out->gain = (float)GrappleGen_LuaFieldNum(L, idx, "gain");
    out->pan = (float)GrappleGen_LuaFieldNum(L, idx, "pan");
    out->muted = (bool)GrappleGen_LuaFieldBool(L, idx, "muted");
    out->solo = (bool)GrappleGen_LuaFieldBool(L, idx, "solo");
}

static void GenPush_Grapple_ChipTrackMix(lua_State *L, const Grapple_ChipTrackMix *in)
{
    lua_createtable(L, 0, 4);
    lua_pushnumber(L, (lua_Number)in->gain);
    lua_setfield(L, -2, "gain");
    lua_pushnumber(L, (lua_Number)in->pan);
    lua_setfield(L, -2, "pan");
    lua_pushboolean(L, (int)in->muted);
    lua_setfield(L, -2, "muted");
    lua_pushboolean(L, (int)in->solo);
...
static void GenRead_Grapple_GraphicsSettings(lua_State *L, int idx, Grapple_GraphicsSettings *out)
{
    ...
    out->fullscreen_width = (int)GrappleGen_LuaFieldInt(L, idx, "fullscreen_width");
    out->fullscreen_height = (int)GrappleGen_LuaFieldInt(L, idx, "fullscreen_height");
    out->refresh_rate = (float)GrappleGen_LuaFieldNum(L, idx, "refresh_rate");
    out->primary_display = (bool)GrappleGen_LuaFieldBool(L, idx, "primary_display");
    out->effects_disabled = (bool)GrappleGen_LuaFieldBool(L, idx, "effects_disabled");
}
...
static void GenPush_Grapple_GraphicsSettings(lua_State *L, const Grapple_GraphicsSettings *in)
{
    ...
    lua_pushinteger(L, (lua_Integer)in->fullscreen_width);
    lua_setfield(L, -2, "fullscreen_width");
    lua_pushinteger(L, (lua_Integer)in->fullscreen_height);
    lua_setfield(L, -2, "fullscreen_height");
    lua_pushnumber(L, (lua_Number)in->refresh_rate);
    lua_setfield(L, -2, "refresh_rate");
    lua_pushboolean(L, (int)in->primary_display);
    lua_setfield(L, -2, "primary_display");
    lua_pushboolean(L, (int)in->effects_disabled);
    lua_setfield(L, -2, "effects_disabled");
}
...
static int GenL_Grapple_AddChipSection(lua_State *L)
{
    (void)L;
    Grapple_ChipComposer *a0 = (Grapple_ChipComposer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipComposer");
    const char *a1 = lua_isnoneornil(L, 2) ? NULL : luaL_checkstring(L, 2);
...
static int GenL_Grapple_AddChipTempo(lua_State *L)
{
    (void)L;
    Grapple_ChipComposer *a0 = (Grapple_ChipComposer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipComposer");
...
static int GenL_Grapple_ApplyAudioBus(lua_State *L)
{
    (void)L;
    Grapple_AudioBus a0 = (Grapple_AudioBus)luaL_checkinteger(L, 1);
    float io1 = (float)luaL_optnumber(L, 2, 0);
    int a2 = (int)luaL_checkinteger(L, 3);
...
static int GenL_Grapple_AttachAudioBuses(lua_State *L)
{
    (void)L;
...
static int GenL_Grapple_AudioMuted(lua_State *L)
{
    (void)L;
...
static int GenL_Grapple_BuildChipSong(lua_State *L)
{
    (void)L;
    const Grapple_ChipComposer *a0 = (const Grapple_ChipComposer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipComposer");
    Uint64 a1 = (Uint64)luaL_checkinteger(L, 2);
    Grapple_ChipSong * rv = Grapple_BuildChipSong(a0, a1);
    GrappleGen_LuaPushOwned(L, (void *)rv, "Grapple_ChipSong", GenDtor_Grapple_DestroyChipSong);
    return 1;
}
...
static int GenL_Grapple_ChipPlayerPlaying(lua_State *L)
{
    (void)L;
...
static int GenL_Grapple_CloneSettings(lua_State *L)
{
    (void)L;
    const Grapple_Settings *a0 = (const Grapple_Settings *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Settings");
    Grapple_Settings * rv = Grapple_CloneSettings(a0);
    GrappleGen_LuaPushHandle(L, (void *)rv, "Grapple_Settings");
    return 1;
}
...
static int GenL_Grapple_CreateAudioMixer(lua_State *L)
{
    (void)L;
...
static int GenL_Grapple_CreateChipComposer(lua_State *L)
{
    (void)L;
    int a0 = (int)luaL_checkinteger(L, 1);
    int a1 = (int)luaL_checkinteger(L, 2);
    Grapple_ChipComposer * rv = Grapple_CreateChipComposer(a0, a1);
    GrappleGen_LuaPushOwned(L, (void *)rv, "Grapple_ChipComposer", GenDtor_Grapple_DestroyChipComposer);
    return 1;
}

static int GenL_Grapple_CreateChipPlayer(lua_State *L)
{
    (void)L;
...
static int GenL_Grapple_CreatePlatformer(lua_State *L)
{
    (void)L;
    Grapple_Engine *a0 = (Grapple_Engine *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Engine");
    int a1 = (int)luaL_checkinteger(L, 2);
    ...
    GrappleGen_LuaPushOwned(L, (void *)rv, "Grapple_Platformer", GenDtor_Grapple_DestroyPlatformer);
    return 1;
}

static int GenL_Grapple_CreateSettings(lua_State *L)
{
    (void)L;
...
static int GenL_Grapple_DescribeRenderBackend(lua_State *L)
{
    (void)L;
    SDL_Renderer *a0 = (SDL_Renderer *)GrappleGen_LuaCheckHandle(L, 1, "SDL_Renderer");
...
static int GenL_Grapple_DestroyChipComposer(lua_State *L)
{
    (void)L;
    Grapple_ChipComposer *a0 = (Grapple_ChipComposer *)GrappleGen_LuaTakeHandle(L, 1, "Grapple_ChipComposer");
    Grapple_DestroyChipComposer(a0);
    return 0;
}

static int GenL_Grapple_DestroyChipPlayer(lua_State *L)
{
    (void)L;
    Grapple_ChipPlayer *a0 = (Grapple_ChipPlayer *)GrappleGen_LuaTakeHandle(L, 1, "Grapple_ChipPlayer");
    Grapple_DestroyChipPlayer(a0);
    return 0;
}

static int GenL_Grapple_DestroyChipSong(lua_State *L)
{
    (void)L;
...
static int GenL_Grapple_DestroyPlatformer(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaTakeHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_DestroySettings(lua_State *L)
{
    (void)L;
    Grapple_Settings *a0 = (Grapple_Settings *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Settings");
...
static int GenL_Grapple_EngineActualSettings(lua_State *L)
{
    (void)L;
    Grapple_Engine *a0 = (Grapple_Engine *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Engine");
...
static int GenL_Grapple_EngineRequestedSettings(lua_State *L)
{
    (void)L;
    Grapple_Engine *a0 = (Grapple_Engine *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Engine");
...
static int GenL_Grapple_EngineUiPoints(lua_State *L)
{
    (void)L;
    Grapple_Engine *a0 = (Grapple_Engine *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Engine");
    float a1 = (float)luaL_checknumber(L, 2);
...
static int GenL_Grapple_GetAudioBusGain(lua_State *L)
{
    (void)L;
    Grapple_AudioBus a0 = (Grapple_AudioBus)luaL_checkinteger(L, 1);
...
static int GenL_Grapple_GetChipDiagnosticCount(lua_State *L)
{
    (void)L;
    const Grapple_ChipSong *a0 = (const Grapple_ChipSong *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipSong");
...
static int GenL_Grapple_GetChipDiagnosticMessage(lua_State *L)
{
    (void)L;
    const Grapple_ChipSong *a0 = (const Grapple_ChipSong *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipSong");
    int a1 = (int)luaL_checkinteger(L, 2);
...
static int GenL_Grapple_GetChipImportDefaults(lua_State *L)
{
    ...
    lua_pushboolean(L, (int)rv);
    GenPush_Grapple_ChipImportOptions(L, &out0);
    return 2;
}

static int GenL_Grapple_GetChipPlayerPeakVoices(lua_State *L)
{
    (void)L;
    Grapple_ChipPlayer *a0 = (Grapple_ChipPlayer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipPlayer");
...
{
    (void)L;
    Grapple_ChipPreset a0 = (Grapple_ChipPreset)luaL_checkinteger(L, 1);
    Grapple_ChipEffects out1;
    memset(&out1, 0, sizeof(out1));
    bool rv = Grapple_GetChipPresetEffects(a0, &out1);
    lua_pushboolean(L, (int)rv);
    GenPush_Grapple_ChipEffects(L, &out1);
    return 2;
}

static int GenL_Grapple_GetChipSectionCount(lua_State *L)
{
    (void)L;
    const Grapple_ChipSong *a0 = (const Grapple_ChipSong *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipSong");
...
static int GenL_Grapple_GetLaunchSettings(lua_State *L)
{
    (void)L;
...
static int GenL_Grapple_LoadChipSong(lua_State *L)
{
    (void)L;
    const char *a0 = lua_isnoneornil(L, 1) ? NULL : luaL_checkstring(L, 1);
...
static int GenL_Grapple_LoadChipSongEx(lua_State *L)
{
    (void)L;
    const char *a0 = lua_isnoneornil(L, 1) ? NULL : luaL_checkstring(L, 1);
    ...
    if (!lua_isnoneornil(L, 2)) {
        GenRead_Grapple_ChipImportOptions(L, 2, &tmp1);
        a1 = &tmp1;
    }
    ...
    GrappleGen_LuaPushOwned(L, (void *)rv, "Grapple_ChipSong", GenDtor_Grapple_DestroyChipSong);
    GenPush_Grapple_ChipDiagnostic(L, &out2);
    return 2;
}
...
static int GenL_Grapple_LoadPlatformer(lua_State *L)
{
    (void)L;
    Grapple_Engine *a0 = (Grapple_Engine *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Engine");
    const char *a1 = lua_isnoneornil(L, 2) ? NULL : luaL_checkstring(L, 2);
...
static int GenL_Grapple_PauseChipPlayer(lua_State *L)
{
    (void)L;
    Grapple_ChipPlayer *a0 = (Grapple_ChipPlayer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipPlayer");
...
static int GenL_Grapple_PlatformerActionDown(lua_State *L)
{
    (void)L;
...
static int GenL_Grapple_PlatformerActionPressed(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    const char *a1 = lua_isnoneornil(L, 2) ? NULL : luaL_checkstring(L, 2);
...
static int GenL_Grapple_PlatformerActionReleased(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    const char *a1 = lua_isnoneornil(L, 2) ? NULL : luaL_checkstring(L, 2);
...
static int GenL_Grapple_PlatformerActionValue(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    const char *a1 = lua_isnoneornil(L, 2) ? NULL : luaL_checkstring(L, 2);
...
static int GenL_Grapple_PlatformerActions(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerAddSolid(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    float a1 = (float)luaL_checknumber(L, 2);
...
static int GenL_Grapple_PlatformerAttach(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerAttached(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerBind(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    const char *a1 = lua_isnoneornil(L, 2) ? NULL : luaL_checkstring(L, 2);
...
static int GenL_Grapple_PlatformerCameraPosition(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    float io1 = (float)luaL_optnumber(L, 2, 0);
...
static int GenL_Grapple_PlatformerCreateBlock(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    int a1 = (int)luaL_checkinteger(L, 2);
...
static int GenL_Grapple_PlatformerCreateFloor(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    int a1 = (int)luaL_checkinteger(L, 2);
...
static int GenL_Grapple_PlatformerCreatePlayer(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    int a1 = (int)luaL_checkinteger(L, 2);
...
static int GenL_Grapple_PlatformerCreateStairs(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    int a1 = (int)luaL_checkinteger(L, 2);
...
static int GenL_Grapple_PlatformerCreateWall(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    int a1 = (int)luaL_checkinteger(L, 2);
...
static int GenL_Grapple_PlatformerDetach(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerEngine(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerFillTiles(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    int a1 = (int)luaL_checkinteger(L, 2);
    ...
    int a3 = (int)luaL_checkinteger(L, 4);
    int a4 = (int)luaL_checkinteger(L, 5);
    Grapple_PlatformerTile a5 = (Grapple_PlatformerTile)luaL_checkinteger(L, 6);
    int rv = Grapple_PlatformerFillTiles(a0, a1, a2, a3, a4, a5);
    lua_pushinteger(L, (lua_Integer)rv);
    return 1;
}

static int GenL_Grapple_PlatformerHasPlayer(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerHeight(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerPixelSize(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    float io1 = (float)luaL_optnumber(L, 2, 0);
...
static int GenL_Grapple_PlatformerPlayer(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerPlayerFacing(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerPlayerFell(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerPlayerJumped(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerPlayerLanded(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerPlayerPaused(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerPlayerPosition(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    float io1 = (float)luaL_optnumber(L, 2, 0);
...
static int GenL_Grapple_PlatformerPlayerRespawn(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    float a1 = (float)luaL_checknumber(L, 2);
...
static int GenL_Grapple_PlatformerPlayerRespawnAtStart(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerPlayerSize(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    float io1 = (float)luaL_optnumber(L, 2, 0);
...
static int GenL_Grapple_PlatformerPlayerState(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerPlayerStateChanged(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerPlayerStateName(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerPlayerTuning(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    const char *a1 = lua_isnoneornil(L, 2) ? NULL : luaL_checkstring(L, 2);
...
static int GenL_Grapple_PlatformerPlayerTuningCount(lua_State *L)
{
    (void)L;
...
static int GenL_Grapple_PlatformerPlayerTuningKey(lua_State *L)
{
    (void)L;
    int a0 = (int)luaL_checkinteger(L, 1);
...
static int GenL_Grapple_PlatformerPlayerVelocity(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    float io1 = (float)luaL_optnumber(L, 2, 0);
...
static int GenL_Grapple_PlatformerRemoveSolid(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    int a1 = (int)luaL_checkinteger(L, 2);
...
static int GenL_Grapple_PlatformerRender(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    float a1 = (float)luaL_checknumber(L, 2);
...
static int GenL_Grapple_PlatformerScriptInput(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    float a1 = (float)luaL_checknumber(L, 2);
...
static int GenL_Grapple_PlatformerScriptedInput(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerScrollMode(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerSetBackgroundColor(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    float a1 = (float)luaL_checknumber(L, 2);
...
static int GenL_Grapple_PlatformerSetCameraSmoothing(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    float a1 = (float)luaL_checknumber(L, 2);
...
static int GenL_Grapple_PlatformerSetPlayerColor(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    float a1 = (float)luaL_checknumber(L, 2);
...
static int GenL_Grapple_PlatformerSetPlayerPaused(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    bool a1 = (bool)lua_toboolean(L, 2);
...
static int GenL_Grapple_PlatformerSetPlayerSize(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    float a1 = (float)luaL_checknumber(L, 2);
...
static int GenL_Grapple_PlatformerSetPlayerTuning(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    const char *a1 = lua_isnoneornil(L, 2) ? NULL : luaL_checkstring(L, 2);
...
static int GenL_Grapple_PlatformerSetScriptedInput(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    bool a1 = (bool)lua_toboolean(L, 2);
...
static int GenL_Grapple_PlatformerSetScroll(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    Grapple_PlatformerScroll a1 = (Grapple_PlatformerScroll)luaL_checkinteger(L, 2);
    Grapple_PlatformerSetScroll(a0, a1);
    return 0;
}

static int GenL_Grapple_PlatformerSetTile(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    int a1 = (int)luaL_checkinteger(L, 2);
    int a2 = (int)luaL_checkinteger(L, 3);
    Grapple_PlatformerTile a3 = (Grapple_PlatformerTile)luaL_checkinteger(L, 4);
    bool rv = Grapple_PlatformerSetTile(a0, a1, a2, a3);
    lua_pushboolean(L, (int)rv);
    return 1;
}

static int GenL_Grapple_PlatformerSetTileColor(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    Grapple_PlatformerTile a1 = (Grapple_PlatformerTile)luaL_checkinteger(L, 2);
    float a2 = (float)luaL_checknumber(L, 3);
    float a3 = (float)luaL_checknumber(L, 4);
    float a4 = (float)luaL_checknumber(L, 5);
...
static int GenL_Grapple_PlatformerSetTileTexture(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    Grapple_PlatformerTile a1 = (Grapple_PlatformerTile)luaL_checkinteger(L, 2);
...
static int GenL_Grapple_PlatformerStep(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    float a1 = (float)luaL_checknumber(L, 2);
...
static int GenL_Grapple_PlatformerTileAt(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    int a1 = (int)luaL_checkinteger(L, 2);
...
static int GenL_Grapple_PlatformerTileSize(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlatformerUpdate(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
    float a1 = (float)luaL_checknumber(L, 2);
...
static int GenL_Grapple_PlatformerWidth(lua_State *L)
{
    (void)L;
    Grapple_Platformer *a0 = (Grapple_Platformer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Platformer");
...
static int GenL_Grapple_PlayerStateName(lua_State *L)
{
    (void)L;
    Grapple_PlayerState a0 = (Grapple_PlayerState)luaL_checkinteger(L, 1);
...
static int GenL_Grapple_ReadChipDiagnostic(lua_State *L)
{
    (void)L;
    const Grapple_ChipSong *a0 = (const Grapple_ChipSong *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipSong");
    int a1 = (int)luaL_checkinteger(L, 2);
...
static int GenL_Grapple_ReadChipPlayerPosition(lua_State *L)
{
    (void)L;
    Grapple_ChipPlayer *a0 = (Grapple_ChipPlayer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipPlayer");
    ...
    lua_pushboolean(L, (int)rv);
    GenPush_Grapple_ChipPosition(L, &out1);
    return 2;
}
...
static int GenL_Grapple_ReadChipSection(lua_State *L)
{
    ...
    lua_pushboolean(L, (int)rv);
    GenPush_Grapple_ChipSection(L, &out2);
    return 2;
}

static int GenL_Grapple_ReadChipSongInfo(lua_State *L)
{
    (void)L;
    const Grapple_ChipSong *a0 = (const Grapple_ChipSong *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipSong");
    ...
    lua_pushboolean(L, (int)rv);
    GenPush_Grapple_ChipSongInfo(L, &out1);
    return 2;
}
...
static int GenL_Grapple_ReadChipTrackEffects(lua_State *L)
{
    ...
    Grapple_ChipPlayer *a0 = (Grapple_ChipPlayer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipPlayer");
    int a1 = (int)luaL_checkinteger(L, 2);
    Grapple_ChipPreset a2 = (Grapple_ChipPreset)luaL_checkinteger(L, 3);
    Grapple_ChipEffects out3;
    memset(&out3, 0, sizeof(out3));
    bool rv = Grapple_ReadChipTrackEffects(a0, a1, a2, &out3);
    lua_pushboolean(L, (int)rv);
    GenPush_Grapple_ChipEffects(L, &out3);
    return 2;
}

static int GenL_Grapple_ReadChipTrackMapping(lua_State *L)
{
    (void)L;
    Grapple_ChipPlayer *a0 = (Grapple_ChipPlayer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipPlayer");
    int a1 = (int)luaL_checkinteger(L, 2);
    ...
    lua_pushboolean(L, (int)rv);
    GenPush_Grapple_ChipMapping(L, &out3);
    return 2;
}

static int GenL_Grapple_ReadChipTrackMix(lua_State *L)
{
    (void)L;
    Grapple_ChipPlayer *a0 = (Grapple_ChipPlayer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipPlayer");
    int a1 = (int)luaL_checkinteger(L, 2);
    ...
    lua_pushboolean(L, (int)rv);
    GenPush_Grapple_ChipTrackMix(L, &out2);
    return 2;
}
...
static int GenL_Grapple_ResetChipPlayer(lua_State *L)
{
    (void)L;
    Grapple_ChipPlayer *a0 = (Grapple_ChipPlayer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipPlayer");
...
static int GenL_Grapple_RouteAudioTrack(lua_State *L)
{
    (void)L;
    MIX_Track *a0 = (MIX_Track *)GrappleGen_LuaCheckHandle(L, 1, "MIX_Track");
    Grapple_AudioBus a1 = (Grapple_AudioBus)luaL_checkinteger(L, 2);
...
static int GenL_Grapple_ScenePending(lua_State *L)
{
    (void)L;
    Grapple_Engine *a0 = (Grapple_Engine *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Engine");
...
static int GenL_Grapple_SeekChipPlayer(lua_State *L)
{
    (void)L;
    Grapple_ChipPlayer *a0 = (Grapple_ChipPlayer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipPlayer");
    Uint64 a1 = (Uint64)luaL_checkinteger(L, 2);
...
static int GenL_Grapple_SetAudioBusGain(lua_State *L)
{
    (void)L;
    Grapple_AudioBus a0 = (Grapple_AudioBus)luaL_checkinteger(L, 1);
    float a1 = (float)luaL_checknumber(L, 2);
...
static int GenL_Grapple_SetAudioMuted(lua_State *L)
{
    (void)L;
...
static int GenL_Grapple_SetChipPart(lua_State *L)
{
    (void)L;
    Grapple_ChipComposer *a0 = (Grapple_ChipComposer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipComposer");
    int a1 = (int)luaL_checkinteger(L, 2);
    const char *a2 = lua_isnoneornil(L, 3) ? NULL : luaL_checkstring(L, 3);
    Grapple_ChipPreset a3 = (Grapple_ChipPreset)luaL_checkinteger(L, 4);
    float a4 = (float)luaL_checknumber(L, 5);
...
static int GenL_Grapple_SetChipPlayerGain(lua_State *L)
{
    (void)L;
    Grapple_ChipPlayer *a0 = (Grapple_ChipPlayer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipPlayer");
    float a1 = (float)luaL_checknumber(L, 2);
...
static int GenL_Grapple_SetChipPlayerLoop(lua_State *L)
{
    (void)L;
    Grapple_ChipPlayer *a0 = (Grapple_ChipPlayer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipPlayer");
    Uint64 a1 = (Uint64)luaL_checkinteger(L, 2);
...
static int GenL_Grapple_SetChipPlayerTempo(lua_State *L)
{
    (void)L;
    Grapple_ChipPlayer *a0 = (Grapple_ChipPlayer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipPlayer");
...
static int GenL_Grapple_SetChipPresetEffects(lua_State *L)
{
    (void)L;
    Grapple_ChipPlayer *a0 = (Grapple_ChipPlayer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipPlayer");
    Grapple_ChipPreset a1 = (Grapple_ChipPreset)luaL_checkinteger(L, 2);
    ...
    if (!lua_isnoneornil(L, 3)) {
        GenRead_Grapple_ChipEffects(L, 3, &tmp2);
        a2 = &tmp2;
    }
...
static int GenL_Grapple_SetChipTrackMix(lua_State *L)
{
    (void)L;
    Grapple_ChipPlayer *a0 = (Grapple_ChipPlayer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipPlayer");
    int a1 = (int)luaL_checkinteger(L, 2);
    ...
    if (!lua_isnoneornil(L, 3)) {
        GenRead_Grapple_ChipTrackMix(L, 3, &tmp2);
        a2 = &tmp2;
    }
...
static int GenL_Grapple_SetChipTrackPreset(lua_State *L)
{
    (void)L;
    Grapple_ChipPlayer *a0 = (Grapple_ChipPlayer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipPlayer");
    int a1 = (int)luaL_checkinteger(L, 2);
...
static int GenL_Grapple_SetLaunchSettings(lua_State *L)
{
    (void)L;
    const Grapple_Settings *a0 = (const Grapple_Settings *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Settings");
...
static int GenL_Grapple_SettingChoices(lua_State *L)
{
    (void)L;
    int a0 = (int)luaL_checkinteger(L, 1);
...
static int GenL_Grapple_SettingCount(lua_State *L)
{
    (void)L;
...
static int GenL_Grapple_SettingKey(lua_State *L)
{
    (void)L;
    int a0 = (int)luaL_checkinteger(L, 1);
...
static int GenL_Grapple_SettingOption(lua_State *L)
{
    (void)L;
    int a0 = (int)luaL_checkinteger(L, 1);
...
static int GenL_Grapple_SettingPolicy(lua_State *L)
{
    (void)L;
    const char *a0 = lua_isnoneornil(L, 1) ? NULL : luaL_checkstring(L, 1);
...
static int GenL_Grapple_SettingsApply(lua_State *L)
{
    (void)L;
    const Grapple_Settings *a0 = (const Grapple_Settings *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Settings");
    Grapple_EngineConfig *a1 = (Grapple_EngineConfig *)GrappleGen_LuaCheckHandle(L, 2, "Grapple_EngineConfig");
    Grapple_GraphicsSettings out2;
    memset(&out2, 0, sizeof(out2));
    bool a3 = (bool)lua_toboolean(L, 3);
    bool rv = Grapple_SettingsApply(a0, a1, &out2, a3);
    lua_pushboolean(L, (int)rv);
    GenPush_Grapple_GraphicsSettings(L, &out2);
    return 2;
}

static int GenL_Grapple_SettingsCapture(lua_State *L)
{
    (void)L;
    const Grapple_EngineConfig *a0 = (const Grapple_EngineConfig *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_EngineConfig");
    Grapple_GraphicsSettings tmp1;
...
static int GenL_Grapple_SettingsGet(lua_State *L)
{
    (void)L;
    const Grapple_Settings *a0 = (const Grapple_Settings *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Settings");
    const char *a1 = lua_isnoneornil(L, 2) ? NULL : luaL_checkstring(L, 2);
...
static int GenL_Grapple_SettingsLoadFile(lua_State *L)
{
    (void)L;
    Grapple_Settings *a0 = (Grapple_Settings *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Settings");
    const char *a1 = lua_isnoneornil(L, 2) ? NULL : luaL_checkstring(L, 2);
...
static int GenL_Grapple_SettingsLoadToml(lua_State *L)
{
    (void)L;
    Grapple_Settings *a0 = (Grapple_Settings *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Settings");
    const char *a1 = lua_isnoneornil(L, 2) ? NULL : luaL_checkstring(L, 2);
...
static int GenL_Grapple_SettingsOverlay(lua_State *L)
{
    (void)L;
    Grapple_Settings *a0 = (Grapple_Settings *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Settings");
    const Grapple_Settings *a1 = (const Grapple_Settings *)GrappleGen_LuaCheckHandle(L, 2, "Grapple_Settings");
    bool rv = Grapple_SettingsOverlay(a0, a1);
    lua_pushboolean(L, (int)rv);
    return 1;
}

static int GenL_Grapple_SettingsPlayerPath(lua_State *L)
{
    (void)L;
    const Grapple_Settings *a0 = (const Grapple_Settings *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Settings");
...
static int GenL_Grapple_SettingsQuality(lua_State *L)
{
    (void)L;
    Grapple_Settings *a0 = (Grapple_Settings *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Settings");
    const char *a1 = lua_isnoneornil(L, 2) ? NULL : luaL_checkstring(L, 2);
...
static int GenL_Grapple_SettingsSaveChanges(lua_State *L)
{
    (void)L;
    const Grapple_Settings *a0 = (const Grapple_Settings *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Settings");
    const char *a1 = lua_isnoneornil(L, 2) ? NULL : luaL_checkstring(L, 2);
...
static int GenL_Grapple_SettingsSet(lua_State *L)
{
    (void)L;
    Grapple_Settings *a0 = (Grapple_Settings *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Settings");
    const char *a1 = lua_isnoneornil(L, 2) ? NULL : luaL_checkstring(L, 2);
...
static int GenL_Grapple_SettingsSetPlayerPath(lua_State *L)
{
    (void)L;
    Grapple_Settings *a0 = (Grapple_Settings *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Settings");
    const char *a1 = lua_isnoneornil(L, 2) ? NULL : luaL_checkstring(L, 2);
...
static int GenL_Grapple_SettingsSource(lua_State *L)
{
    (void)L;
    const Grapple_Settings *a0 = (const Grapple_Settings *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Settings");
    const char *a1 = lua_isnoneornil(L, 2) ? NULL : luaL_checkstring(L, 2);
...
static int GenL_Grapple_SettingsToToml(lua_State *L)
{
    (void)L;
    const Grapple_Settings *a0 = (const Grapple_Settings *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_Settings");
    bool a1 = (bool)lua_toboolean(L, 2);
...
static int GenL_Grapple_StopChipPlayer(lua_State *L)
{
    (void)L;
    Grapple_ChipPlayer *a0 = (Grapple_ChipPlayer *)GrappleGen_LuaCheckHandle(L, 1, "Grapple_ChipPlayer");
...
int GrappleGen_OpenLua_grapple(lua_State *L)
{
    ...
    lua_pushcfunction(L, GenL_Grapple_ApplyAudioBus);
    lua_setfield(L, -2, "ApplyAudioBus");
    ...
    lua_pushcfunction(L, GenL_Grapple_AttachAudioBuses);
    lua_setfield(L, -2, "AttachAudioBuses");
    lua_pushcfunction(L, GenL_Grapple_AudioMuted);
    lua_setfield(L, -2, "AudioMuted");
    ...
    lua_pushcfunction(L, GenL_Grapple_BuildChipSong);
    lua_setfield(L, -2, "BuildChipSong");
    ...
    lua_pushcfunction(L, GenL_Grapple_ChipPlayerPlaying);
    lua_setfield(L, -2, "ChipPlayerPlaying");
    lua_pushcfunction(L, GenL_Grapple_CloneSettings);
    lua_setfield(L, -2, "CloneSettings");
    ...
    lua_pushcfunction(L, GenL_Grapple_CreateAudioMixer);
    lua_setfield(L, -2, "CreateAudioMixer");
    ...
    lua_setfield(L, -2, "CreateChipPlayer");
    ...
    lua_pushcfunction(L, GenL_Grapple_CreatePlatformer);
    lua_setfield(L, -2, "CreatePlatformer");
    lua_pushcfunction(L, GenL_Grapple_CreateSettings);
    lua_setfield(L, -2, "CreateSettings");
    ...
    lua_pushcfunction(L, GenL_Grapple_DescribeRenderBackend);
    lua_setfield(L, -2, "DescribeRenderBackend");
    lua_pushcfunction(L, GenL_Grapple_DestroyChipComposer);
    lua_setfield(L, -2, "DestroyChipComposer");
    lua_pushcfunction(L, GenL_Grapple_DestroyChipPlayer);
    ...
    lua_pushcfunction(L, GenL_Grapple_DestroyPlatformer);
    lua_setfield(L, -2, "DestroyPlatformer");
    lua_pushcfunction(L, GenL_Grapple_DestroyRegex);
    lua_setfield(L, -2, "DestroyRegex");
    lua_pushcfunction(L, GenL_Grapple_DestroySettings);
    lua_setfield(L, -2, "DestroySettings");
    ...
    lua_pushcfunction(L, GenL_Grapple_EngineActualSettings);
    lua_setfield(L, -2, "EngineActualSettings");
    ...
    lua_pushcfunction(L, GenL_Grapple_EngineRequestedSettings);
    lua_setfield(L, -2, "EngineRequestedSettings");
    ...
    lua_pushcfunction(L, GenL_Grapple_EngineUiPoints);
    lua_setfield(L, -2, "EngineUiPoints");
    ...
    lua_pushcfunction(L, GenL_Grapple_GetAudioBusGain);
    lua_setfield(L, -2, "GetAudioBusGain");
    lua_pushcfunction(L, GenL_Grapple_GetChipDiagnosticCount);
    ...
    lua_pushcfunction(L, GenL_Grapple_LoadChipSong);
    ...
    lua_pushcfunction(L, GenL_Grapple_LoadPlatformer);
    lua_setfield(L, -2, "LoadPlatformer");
    ...
    lua_pushcfunction(L, GenL_Grapple_PauseChipPlayer);
    lua_setfield(L, -2, "PauseChipPlayer");
    ...
    lua_pushcfunction(L, GenL_Grapple_PlatformerActionDown);
    lua_setfield(L, -2, "PlatformerActionDown");
    lua_pushcfunction(L, GenL_Grapple_PlatformerActionPressed);
    lua_setfield(L, -2, "PlatformerActionPressed");
    lua_pushcfunction(L, GenL_Grapple_PlatformerActionReleased);
    lua_setfield(L, -2, "PlatformerActionReleased");
    lua_pushcfunction(L, GenL_Grapple_PlatformerActionValue);
    lua_setfield(L, -2, "PlatformerActionValue");
    lua_pushcfunction(L, GenL_Grapple_PlatformerActions);
    lua_setfield(L, -2, "PlatformerActions");
    lua_pushcfunction(L, GenL_Grapple_PlatformerAddSolid);
    lua_setfield(L, -2, "PlatformerAddSolid");
    lua_pushcfunction(L, GenL_Grapple_PlatformerAttach);
    lua_setfield(L, -2, "PlatformerAttach");
    lua_pushcfunction(L, GenL_Grapple_PlatformerAttached);
    lua_setfield(L, -2, "PlatformerAttached");
    lua_pushcfunction(L, GenL_Grapple_PlatformerBind);
    lua_setfield(L, -2, "PlatformerBind");
    lua_pushcfunction(L, GenL_Grapple_PlatformerCameraPosition);
    lua_setfield(L, -2, "PlatformerCameraPosition");
    lua_pushcfunction(L, GenL_Grapple_PlatformerCreateBlock);
    ...
    lua_setfield(L, -2, "PlatformerCreateWall");
    lua_pushcfunction(L, GenL_Grapple_PlatformerDetach);
    lua_setfield(L, -2, "PlatformerDetach");
    lua_pushcfunction(L, GenL_Grapple_PlatformerEngine);
    lua_setfield(L, -2, "PlatformerEngine");
    lua_pushcfunction(L, GenL_Grapple_PlatformerFillTiles);
    lua_setfield(L, -2, "PlatformerFillTiles");
    lua_pushcfunction(L, GenL_Grapple_PlatformerHasPlayer);
    lua_setfield(L, -2, "PlatformerHasPlayer");
    lua_pushcfunction(L, GenL_Grapple_PlatformerHeight);
    lua_setfield(L, -2, "PlatformerHeight");
    lua_pushcfunction(L, GenL_Grapple_PlatformerPixelSize);
    ...
    lua_setfield(L, -2, "PlatformerPlayerPosition");
    lua_pushcfunction(L, GenL_Grapple_PlatformerPlayerRespawn);
    lua_setfield(L, -2, "PlatformerPlayerRespawn");
    lua_pushcfunction(L, GenL_Grapple_PlatformerPlayerRespawnAtStart);
    lua_setfield(L, -2, "PlatformerPlayerRespawnAtStart");
    lua_pushcfunction(L, GenL_Grapple_PlatformerPlayerSize);
    lua_setfield(L, -2, "PlatformerPlayerSize");
    lua_pushcfunction(L, GenL_Grapple_PlatformerPlayerState);
    lua_setfield(L, -2, "PlatformerPlayerState");
    lua_pushcfunction(L, GenL_Grapple_PlatformerPlayerStateChanged);
    lua_setfield(L, -2, "PlatformerPlayerStateChanged");
    lua_pushcfunction(L, GenL_Grapple_PlatformerPlayerStateName);
    lua_setfield(L, -2, "PlatformerPlayerStateName");
    lua_pushcfunction(L, GenL_Grapple_PlatformerPlayerTuning);
    lua_setfield(L, -2, "PlatformerPlayerTuning");
    lua_pushcfunction(L, GenL_Grapple_PlatformerPlayerTuningCount);
    lua_setfield(L, -2, "PlatformerPlayerTuningCount");
    lua_pushcfunction(L, GenL_Grapple_PlatformerPlayerTuningKey);
    ...
    lua_setfield(L, -2, "PlatformerRemoveSolid");
    lua_pushcfunction(L, GenL_Grapple_PlatformerRender);
    lua_setfield(L, -2, "PlatformerRender");
    lua_pushcfunction(L, GenL_Grapple_PlatformerScriptInput);
    lua_setfield(L, -2, "PlatformerScriptInput");
    lua_pushcfunction(L, GenL_Grapple_PlatformerScriptedInput);
    lua_setfield(L, -2, "PlatformerScriptedInput");
    lua_pushcfunction(L, GenL_Grapple_PlatformerScrollMode);
    ...
    lua_setfield(L, -2, "PlatformerSetPlayerColor");
    lua_pushcfunction(L, GenL_Grapple_PlatformerSetPlayerPaused);
    lua_setfield(L, -2, "PlatformerSetPlayerPaused");
    lua_pushcfunction(L, GenL_Grapple_PlatformerSetPlayerSize);
    lua_setfield(L, -2, "PlatformerSetPlayerSize");
    lua_pushcfunction(L, GenL_Grapple_PlatformerSetPlayerTuning);
    lua_setfield(L, -2, "PlatformerSetPlayerTuning");
    lua_pushcfunction(L, GenL_Grapple_PlatformerSetScriptedInput);
    lua_setfield(L, -2, "PlatformerSetScriptedInput");
    lua_pushcfunction(L, GenL_Grapple_PlatformerSetScroll);
    lua_setfield(L, -2, "PlatformerSetScroll");
    lua_pushcfunction(L, GenL_Grapple_PlatformerSetTile);
    lua_setfield(L, -2, "PlatformerSetTile");
    lua_pushcfunction(L, GenL_Grapple_PlatformerSetTileColor);
    ...
    lua_setfield(L, -2, "PlatformerStep");
    lua_pushcfunction(L, GenL_Grapple_PlatformerTileAt);
    lua_setfield(L, -2, "PlatformerTileAt");
    lua_pushcfunction(L, GenL_Grapple_PlatformerTileSize);
    lua_setfield(L, -2, "PlatformerTileSize");
    lua_pushcfunction(L, GenL_Grapple_PlatformerUpdate);
    lua_setfield(L, -2, "PlatformerUpdate");
    lua_pushcfunction(L, GenL_Grapple_PlatformerWidth);
    lua_setfield(L, -2, "PlatformerWidth");
    ...
    lua_pushcfunction(L, GenL_Grapple_PlayerStateName);
    lua_setfield(L, -2, "PlayerStateName");
    ...
    lua_setfield(L, -2, "ReadChipTrackMapping");
    lua_pushcfunction(L, GenL_Grapple_ReadChipTrackMix);
    lua_setfield(L, -2, "ReadChipTrackMix");
    ...
    lua_pushcfunction(L, GenL_Grapple_ResetChipPlayer);
    lua_setfield(L, -2, "ResetChipPlayer");
    ...
    lua_pushcfunction(L, GenL_Grapple_RouteAudioTrack);
    lua_setfield(L, -2, "RouteAudioTrack");
    ...
    lua_pushcfunction(L, GenL_Grapple_ScenePending);
    lua_setfield(L, -2, "ScenePending");
    ...
    lua_pushcfunction(L, GenL_Grapple_SeekChipPlayer);
    lua_setfield(L, -2, "SeekChipPlayer");
    lua_pushcfunction(L, GenL_Grapple_SetAudioBusGain);
    lua_setfield(L, -2, "SetAudioBusGain");
    lua_pushcfunction(L, GenL_Grapple_SetAudioMuted);
    lua_setfield(L, -2, "SetAudioMuted");
    lua_pushcfunction(L, GenL_Grapple_SetChipPart);
    lua_setfield(L, -2, "SetChipPart");
    lua_pushcfunction(L, GenL_Grapple_SetChipPlayerGain);
    ...
    lua_setfield(L, -2, "SetChipTrackMix");
    lua_pushcfunction(L, GenL_Grapple_SetChipTrackPreset);
    lua_setfield(L, -2, "SetChipTrackPreset");
    ...
    lua_pushcfunction(L, GenL_Grapple_SetLaunchSettings);
    lua_setfield(L, -2, "SetLaunchSettings");
    ...
    lua_pushcfunction(L, GenL_Grapple_SettingChoices);
    lua_setfield(L, -2, "SettingChoices");
    lua_pushcfunction(L, GenL_Grapple_SettingCount);
    lua_setfield(L, -2, "SettingCount");
    lua_pushcfunction(L, GenL_Grapple_SettingKey);
    lua_setfield(L, -2, "SettingKey");
    lua_pushcfunction(L, GenL_Grapple_SettingOption);
    lua_setfield(L, -2, "SettingOption");
    lua_pushcfunction(L, GenL_Grapple_SettingPolicy);
    lua_setfield(L, -2, "SettingPolicy");
    lua_pushcfunction(L, GenL_Grapple_SettingsApply);
    lua_setfield(L, -2, "SettingsApply");
    lua_pushcfunction(L, GenL_Grapple_SettingsCapture);
    lua_setfield(L, -2, "SettingsCapture");
    lua_pushcfunction(L, GenL_Grapple_SettingsGet);
    lua_setfield(L, -2, "SettingsGet");
    lua_pushcfunction(L, GenL_Grapple_SettingsLoadFile);
    lua_setfield(L, -2, "SettingsLoadFile");
    lua_pushcfunction(L, GenL_Grapple_SettingsLoadToml);
    lua_setfield(L, -2, "SettingsLoadToml");
    lua_pushcfunction(L, GenL_Grapple_SettingsOverlay);
    lua_setfield(L, -2, "SettingsOverlay");
    lua_pushcfunction(L, GenL_Grapple_SettingsPlayerPath);
    lua_setfield(L, -2, "SettingsPlayerPath");
    lua_pushcfunction(L, GenL_Grapple_SettingsQuality);
    lua_setfield(L, -2, "SettingsQuality");
    lua_pushcfunction(L, GenL_Grapple_SettingsSaveChanges);
    lua_setfield(L, -2, "SettingsSaveChanges");
    lua_pushcfunction(L, GenL_Grapple_SettingsSet);
    lua_setfield(L, -2, "SettingsSet");
    lua_pushcfunction(L, GenL_Grapple_SettingsSetPlayerPath);
    lua_setfield(L, -2, "SettingsSetPlayerPath");
    lua_pushcfunction(L, GenL_Grapple_SettingsSource);
    lua_setfield(L, -2, "SettingsSource");
    lua_pushcfunction(L, GenL_Grapple_SettingsToToml);
    lua_setfield(L, -2, "SettingsToToml");
    ...
    lua_pushcfunction(L, GenL_Grapple_StopChipPlayer);
    lua_setfield(L, -2, "StopChipPlayer");
    ...
    lua_pushinteger(L, (lua_Integer)GRAPPLE_AUDIO_MASTER);
    lua_setfield(L, -2, "GRAPPLE_AUDIO_MASTER");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_AUDIO_MUSIC);
    lua_setfield(L, -2, "GRAPPLE_AUDIO_MUSIC");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_AUDIO_SFX);
    lua_setfield(L, -2, "GRAPPLE_AUDIO_SFX");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_AUDIO_SPEECH);
    lua_setfield(L, -2, "GRAPPLE_AUDIO_SPEECH");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_AUDIO_AMBIENT);
    lua_setfield(L, -2, "GRAPPLE_AUDIO_AMBIENT");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_AUDIO_BUS_COUNT);
    lua_setfield(L, -2, "GRAPPLE_AUDIO_BUS_COUNT");
    ...
    lua_pushinteger(L, (lua_Integer)GRAPPLE_CHIP_DIAGNOSTIC_NONE);
    lua_setfield(L, -2, "GRAPPLE_CHIP_DIAGNOSTIC_NONE");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_CHIP_DIAGNOSTIC_INPUT);
    lua_setfield(L, -2, "GRAPPLE_CHIP_DIAGNOSTIC_INPUT");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_CHIP_DIAGNOSTIC_SCORE);
    lua_setfield(L, -2, "GRAPPLE_CHIP_DIAGNOSTIC_SCORE");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_CHIP_DIAGNOSTIC_UNSUPPORTED);
    lua_setfield(L, -2, "GRAPPLE_CHIP_DIAGNOSTIC_UNSUPPORTED");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_CHIP_DIAGNOSTIC_APPROXIMATION);
    ...
    lua_setfield(L, -2, "GRAPPLE_CHIP_DIAGNOSTIC_WARNING");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_CHIP_DIAGNOSTIC_ERROR);
    lua_setfield(L, -2, "GRAPPLE_CHIP_DIAGNOSTIC_ERROR");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_CHIP_MAPPING_OVERRIDE);
    lua_setfield(L, -2, "GRAPPLE_CHIP_MAPPING_OVERRIDE");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_CHIP_MAPPING_NAME);
    lua_setfield(L, -2, "GRAPPLE_CHIP_MAPPING_NAME");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_CHIP_MAPPING_PERCUSSION);
    lua_setfield(L, -2, "GRAPPLE_CHIP_MAPPING_PERCUSSION");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_CHIP_MAPPING_PROGRAM);
    lua_setfield(L, -2, "GRAPPLE_CHIP_MAPPING_PROGRAM");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_CHIP_MAPPING_DEFAULT);
    lua_setfield(L, -2, "GRAPPLE_CHIP_MAPPING_DEFAULT");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_CHIP_PRESET_AUTO);
    lua_setfield(L, -2, "GRAPPLE_CHIP_PRESET_AUTO");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_CHIP_PRESET_LEAD);
    lua_setfield(L, -2, "GRAPPLE_CHIP_PRESET_LEAD");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_CHIP_PRESET_BASS);
    lua_setfield(L, -2, "GRAPPLE_CHIP_PRESET_BASS");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_CHIP_PRESET_CHORD);
    lua_setfield(L, -2, "GRAPPLE_CHIP_PRESET_CHORD");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_CHIP_PRESET_RING);
    ...
    lua_pushinteger(L, (lua_Integer)GRAPPLE_PLATFORMER_SCROLL_FREE);
    lua_setfield(L, -2, "GRAPPLE_PLATFORMER_SCROLL_FREE");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_PLATFORMER_SCROLL_FORWARD);
    lua_setfield(L, -2, "GRAPPLE_PLATFORMER_SCROLL_FORWARD");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_PLATFORMER_EMPTY);
    lua_setfield(L, -2, "GRAPPLE_PLATFORMER_EMPTY");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_PLATFORMER_SOLID);
    lua_setfield(L, -2, "GRAPPLE_PLATFORMER_SOLID");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_PLATFORMER_ONE_WAY);
    lua_setfield(L, -2, "GRAPPLE_PLATFORMER_ONE_WAY");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_PLATFORMER_TILE_COUNT);
    lua_setfield(L, -2, "GRAPPLE_PLATFORMER_TILE_COUNT");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_PLAYER_IDLE);
    lua_setfield(L, -2, "GRAPPLE_PLAYER_IDLE");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_PLAYER_WALK);
    lua_setfield(L, -2, "GRAPPLE_PLAYER_WALK");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_PLAYER_RUN);
    lua_setfield(L, -2, "GRAPPLE_PLAYER_RUN");
    lua_pushinteger(L, (lua_Integer)GRAPPLE_PLAYER_JUMP);
    ...
    lua_setfield(L, -2, "GRAPPLE_PLAYER_STATE_COUNT");
