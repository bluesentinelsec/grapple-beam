...
LIBRARIES: list[LibrarySpec] = [
    ...
    LibrarySpec(
        ...
        script_module="MIX",
        prefix="MIX_",
        headers=["modules/mixer/include/SDL3_mixer/*.h"],
    ...
    LibrarySpec(
        ...
        script_module="IMG",
        prefix="IMG_",
        headers=["modules/image/include/SDL3_image/*.h"],
    ...
    LibrarySpec(
        ...
        script_module="TTF",
        prefix="TTF_",
        headers=["modules/ttf/include/SDL3_ttf/*.h"],
    ...
    LibrarySpec(
        ...
        script_module="NET",
        prefix="NET_",
        headers=["modules/net/include/SDL3_net/*.h"],
    ...
    LibrarySpec(
        ...
        prefix="PHYSFS_",
        headers=["modules/vfs/include/physfs.h"],
        includes=["<physfs.h>"],
    ...
    LibrarySpec(
        ...
        script_module="B2",
        prefix="b2",
        headers=["modules/physics/include/box2d/*.h"],
    ...
    LibrarySpec(
        ...
        script_module="NK",
        prefix="nk_",
        headers=["modules/gui/include/nuklear.h"],
    ...
    LibrarySpec(
        ...
        script_module="GFX",
        prefix="",
        headers=["modules/gfx/include/SDL3_gfx/*.h"],
    ...
    LibrarySpec(
        ...
        script_module="TOML",
        prefix="toml_",
        headers=["modules/formats/include/toml.h"],
        includes=["<toml.h>"],
    ),
    LibrarySpec(
        key="yaml",
        ...
        script_module="YAML",
        prefix="yaml_",
        headers=["modules/formats/include/yaml.h"],
        includes=["<yaml.h>"],
    ),
    LibrarySpec(
        key="mog",
    ...
    LibrarySpec(
        ...
        script_module="JSON",
        prefix="cJSON_",
        headers=["modules/formats/include/cJSON.h"],
        includes=["<cJSON.h>"],
    ),
    LibrarySpec(
        key="grapple",
        ...
        prefix="Grapple_",
        headers=[
            "modules/mixer/include/grapple/*.h",
            "modules/gfx/include/grapple/*.h",
            "modules/extras/include/grapple/*.h",
            "modules/vfs/include/grapple/*.h",
            "modules/gui/include/grapple/gui.h",
            "modules/gui/include/grapple/gui_grid.h",
            "modules/tiled/include/grapple/*.h",
            "modules/regex/include/grapple/regex.h",
            "modules/light/include/grapple/light.h",
